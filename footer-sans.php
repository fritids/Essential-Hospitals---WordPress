  ...
  <div class="container">
    ...
    <div class="eight columns element" id="footer_columns"><div class="gutter">
      ...
      <div class="col2">
        <!--Col2-->
        <dl>
          <dt class="color_quality"><a href="<?php echo get_permalink(64); ?>">Quality</a>  </dt>
          <dd>improvement work, success stories, implementation tools </dd>
      ...
      <div class="col3">
        <!--Col3-->
        <dl>
          <dt class="color_institute"><a href="<?php echo get_permalink(621); ?>">Institute</a></dt>
          <dd> about the Institute, Research Center, Transformation Center</dd>

          <dt class="color_policy"> <br/ ><a href="#">Policy Assembly</a></dt>
        </dl>
      </div>
      <div class="col4">
        <!--Col4-->
