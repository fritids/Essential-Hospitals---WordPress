...
?>
				<div class='gutter clearfix'>
					<h2 class='heading'>Requested Connections</h2>
					<div class="myfriends">
						<div class="friendednotify">
							<p>Click to confirm connection request</p>
						</div>
...
?>
				<div class='gutter clearfix'>
					<h2 class='heading'>Pending Connections</h2>
					<div class="myfriends">
...
?>
				<div class='gutter clearfix'>
					<h2 class='heading'>My Connections</h2>
					<div class="myfriends">
						<div class="pendingnotify"></div>
						<div class="membercontent">
<?php 					if ($members!=""){
							...
							echo "<p>Browse and add people to your network of connections</p>";
						}
 ?>
						</div>
					</div>
