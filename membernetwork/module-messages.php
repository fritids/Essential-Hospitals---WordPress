...
<?php 
	foreach($msgs as $msg){
		...
		<div class="msglist">
			<div class="gutter">
				<a href="<?php bloginfo('url'); ?>/member-network-messages/?pmaction=viewmessage&id=<?php echo $msg->id; ?>"><strong><?php echo $fromU->user_firstname; ?> <?php echo $fromU->user_lastname; ?></strong>  <em><?php echo $msgExcerpt; ?></em></a>
			</div>
		</div>
<?php } ?>
