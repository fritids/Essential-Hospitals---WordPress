...
// ----- Email alerts (groups/webinars/messages located in their plugins)
	...
	function comment_message($comment_id, $comment_object){
		...
		//- Notification of user comments to Comms team/site admins
		...
		$message = "A user has commented on the post $postTitle, published $commentDate<br><br>
					...
					<a href='$adminURL/comment.php//?action=editcomment&c=$commentID'>Approve or delete this comment</a><br><br>
					<a href='$reviewURL/edit-comments.php'>View all recent comments</a><br><br>
	...
	function contact_request($toID, $fromID){
		...
		$dashboardURL = get_permalink(244);

		$subject = "$fromFname $fromLname would like to add you as a Member Network contact";
		$message = "Dear $toTitle $toLname,<br><br>
					$fromFname $fromLname $fromHosp, a member of America’s Essential Hospitals, would like to add you as a contact. If you don’t already know this person, he or she may be interested in your work. You may accept this request, and connect with other users, via your <a href='$dashboardURL'>Member Network dashboard</a>.<br><br>
					If you do not wish to connect with this member, ignore or deny the request.<br><br>
					Contact the communications team at America’s Essential Hospitals at <a href='mailto:help@essentialhospitals.org'>help@essentialhospitals.org</a> if you have concerns or questions.";
		$headers = "From: America's Essential Hospitals <info@essentialhospitals.org>";
